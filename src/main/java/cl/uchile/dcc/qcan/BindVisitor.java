...
public class BindVisitor implements ExprVisitor {
    ...
    public BindVisitor(Var var) {
        bindGraph = new RGraph(NodeFactory.createBlankNode(), GraphFactory.createPlainGraph(), Collections.emptyList());
        this.var = var;
    }

    @Override
    public void visit(ExprFunction0 func) {
        nodeStack.add(bindGraph.filterFunction(func.getFunctionSymbol().getSymbol(), Collections.emptyList()));
    }
